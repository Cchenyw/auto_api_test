...
class LoginTest(unittest.TestCase):
    ...
    def test_login_success(self):
        ...
        self.assertEqual(1, res.json()['stat'], f'sign in fail!')
    ...
    def test_phone_null(self):
        ...
        self.assertEqual(400, res.status_code, f'status code error!  response:{res.json()}')
    ...
    def test_header_wrong(self):
        ...
        res = self.req.visit('post', url=self.login_url, data=self.payload, headers=self.header)
        self.assertEqual(412, res.status_code, f'status code error!  response:{res.json()}')
